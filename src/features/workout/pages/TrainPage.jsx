...
function TrainPage() {
  const { activeWorkout, currentProgram, lastWorkoutSummary, streakDays, startWorkout } = useWorkout()
    ...
    <section className="page-section">
      ...
      <div className="launcher-stat-row">
        ...
        <article className="launcher-stat-card">
          ...
          <p>
            {lastWorkoutSummary
              ? `${lastWorkoutSummary.durationMinutes} min · ${lastWorkoutSummary.completedSets} sets`
              : '운동을 시작하면 최근 세션이 여기에 보입니다.'}
          </p>
        </article>
      </div>
      ...
      <div className="train-action-grid">
        ...
        <TrainActionCard
          ...
          subtitle="날짜별 세션과 이전 기록을 다시 봅니다."
          icon="history"
          cta="Review"
        />
        <TrainActionCard
